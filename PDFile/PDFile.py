...
def chat():
    ...
    try:
        ...
        conversation_ref = db.collection('PDFile').document(username).collection('conversations').document(title)
...
def get_conversations():
    ...
    try:
        conversations_ref = db.collection('PDFile').document(username).collection('conversations')
